<div class="left p-2">
    ...
    <div class="item title">
        <a href="{{route('personal.index')}}" class="btn-item">
    ...
    <div class="item title">
        <a href="{{route('barrios.index')}}" class="btn-item">
            <i class="fas fa-city"></i> Barrios
        </a>
    </div>
    <div class="item title">
        <a href="{{route('lugares.index')}}" class="btn-item">
            <i class="fas fa-fw fa-map-marked-alt"></i> Lugares
        </a>    
    </div>
    <div class="item title">
